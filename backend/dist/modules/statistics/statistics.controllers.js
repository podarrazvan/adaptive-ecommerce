...
let StatisticsController = class StatisticsController {
    constructor(statiticsService) {
        this.statiticsService = statiticsService;
    }
...
], StatisticsController.prototype, "createStatistics", null);
__decorate([
    common_1.Put(),
    __param(0, common_1.Body('search')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], StatisticsController.prototype, "addSearch", null);
__decorate([
    common_1.Get(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
...
__decorate([
    common_1.Get('/most-searched'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", Promise)
], StatisticsController.prototype, "getMostSearched", null);
StatisticsController = __decorate([
    common_1.Controller('statistics'),
    __metadata("design:paramtypes", [statistics_service_1.StatisticsService])
], StatisticsController);
exports.StatisticsController = StatisticsController;
//# sourceMappingURL=statistics.controllers.js.map